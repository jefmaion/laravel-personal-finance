...
@section('title')
<i class="fa fa-list" aria-hidden="true"></i> Cartão de Crédito
@endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="block">
            <a name="" id="" class="btn btn-success" href="{{ route('card.create') }}" role="button"><i class="fa fa-plus" aria-hidden="true"></i> Novo Cartão</a>
            <hr>
