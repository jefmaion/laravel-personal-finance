...
@section('title')
<i class="fa fa-money" aria-hidden="true"></i> Contas
@endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="block">
            <a name="" id="" class="btn btn-success" href="{{ route('account.create') }}" role="button"><i class="fa fa-plus" aria-hidden="true"></i> Nova Conta</a>
            <hr>
