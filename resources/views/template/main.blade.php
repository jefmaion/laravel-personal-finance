				...
				<div class="right-menu list-inline no-margin-bottom">
					...
					<div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com"
						...
						<div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#"
								...
								<div class="profile"><img src="{{ asset('assets') }}/img/avatar-3.jpg" alt="..."
										class="img-fluid">
								...
								<div class="profile"><img src="{{ asset('assets') }}/img/avatar-2.jpg" alt="..."
										class="img-fluid">
								...
								<div class="profile"><img src="{{ asset('assets') }}/img/avatar-1.jpg" alt="..."
										class="img-fluid">
								...
								<div class="profile"><img src="{{ asset('assets') }}/img/avatar-5.jpg" alt="..."
										class="img-fluid">
