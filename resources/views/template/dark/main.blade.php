...
<head>
	...
	@include('template.dark.parts.header')
</head>
...
<body>
				...
				<div class="right-menu list-inline no-margin-bottom">
					...
					<div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com"
						...
						<div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#"
								...
								<div class="profile"><img src="{{ asset('dark') }}/img/avatar-3.jpg" alt="..."
										class="img-fluid">
								...
								<div class="profile"><img src="{{ asset('dark') }}/img/avatar-2.jpg" alt="..."
										class="img-fluid">
								...
								<div class="profile"><img src="{{ asset('dark') }}/img/avatar-1.jpg" alt="..."
										class="img-fluid">
								...
								<div class="profile"><img src="{{ asset('dark') }}/img/avatar-5.jpg" alt="..."
										class="img-fluid">
					...
					<div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#"
							...
							class="nav-link language dropdown-toggle"><img
								src="{{ asset('dark') }}/img/flags/16/GB.png" alt="English"><span
								class="d-none d-sm-inline-block">English</span></a>
						<div aria-labelledby="languages" class="dropdown-menu"><a rel="nofollow" href="#"
								class="dropdown-item"> <img src="{{ asset('dark') }}/img/flags/16/DE.png"
									alt="English" class="mr-2"><span>German</span></a><a rel="nofollow" href="#"
								class="dropdown-item"> <img src="{{ asset('dark') }}/img/flags/16/FR.png"
									alt="English" class="mr-2"><span>French </span></a></div>
					</div>
					<!-- Log out               -->
	...
	<div class="d-flex align-items-stretch">
		<!-- Sidebar Navigation-->
		@include('template.dark.parts.sidebar')
		...
		<div class="page-content">
			...
			<section class="no-padding-top no-padding-bottom">
				<div class="container-fluid">
					...
					@include('template.dark.parts.alerts')

					@yield('content')
					
				</div>
			</section>
			@include('template.dark.parts.footer')
		</div>
	</div>
	<!-- JavaScript files-->
	@include('template.dark.parts.scripts')
</body>
