<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <a href="index.html"> <img alt="image" src="{{ asset('otika') }}/img/logo.png" class="header-logo" /> <span
      ...
      <ul class="sidebar-menu">
        ...
        <li class="{{ (\Request::is('transaction*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('transaction.index') }}"><i data-feather="file"></i><span>BlankPage</span></a></li>
        <li class="dropdown">
        ...
        <li class="active"><a class="nav-link" href="blank.html"><i data-feather="file"></i><span>BlankPage</span></a></li>
